...
let FindDelimiter (input: string) : string * string =
    ...
    let delimiter: string = toFindDelimiter[0].Replace("//", "").Replace("[", "").Replace("]", "")
...
let Add (numbers: string) : int =
    ...
    if String.IsNullOrWhiteSpace(numbers) then 0
        ...
        let delimiter, stringifyNewList= FindDelimiter numbers 
